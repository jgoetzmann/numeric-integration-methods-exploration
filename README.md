...
- `repos/`: the five repositories above as submodules, pinned at the commits in the table, plus the private `rk-dev`. `git clone --recurse-submodules` fetches the five public ones and skips `rk-dev`.
