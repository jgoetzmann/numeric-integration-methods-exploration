...
def _rk_section(data):
    ...
    items = [
        ...
        _item("Score",
              ...
              f"Cycle costs come from a model of the Cortex-M0+, not from a chip {c('R7')}."),
        _item("Archive",
    ...
    return (
        ...
        "shows the explicit lane, whose candidates are the ones scored into the archive.</p>"
...
def _novel_section(data):
    ...
    items = [
        ...
        _item("Best-table tracker",
              ...
              f"candidate is the seeded baseline {c('N2')}."),
    ]
